...
<script type="text/javascript">
	function idCheck(id) {
		if (id == "") {
			...
			$.get(url, param, function(data, textStatus) { //응답함수
				$("#idcheck").text(data);
			});
		}
	}
...
<body>
	<div class="container">
		...
		<form class="form-horizontal" action="createProc" method="post" 
			...
			<div class="form-group">
				...
				<button type="button" onclick="emailCheck(document.frm.email.value)"
					class="btn col-sm-2">email 중복확인</button>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="address1" id="sample6_address"
						class="form-control"> <input type="text" name="address2"
