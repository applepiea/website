	...
	public static int rcount(int bbsno, replyInter rinter) {
	 ...
	 public static String rpaging(int total, int nowPage, int recordPerPage, String col, String word, String url,
			 int nPage, String fk, int fno) {
			    ...
			    if (nowGrp >= 2){ 
			      str.append("<li><a href='"+url+"?col="+col+"&word="+word+"&nowPage="+nowPage+fk+"&bbsno="+fno+"&nPage="+_nowPage+"'>이전</A></li>"); 
			    } 
			    ...
			    for(int i=startPage; i<=endPage; i++){ 
			      ...
			      if (nPage == i){ 
			        ...
			        str.append("<li><a href='"+url+"?col="+col+"&word="+word+"&nowPage="+nowPage+fk+"&bbsno="+fno+"&nPage="+i+"'>"+i+"</A></li>");   
			      } 
			    } 
			       
			    _nowPage = (nowGrp * pagePerBlock)+1; // 10개 다음 페이지로 이동 
			    if (nowGrp < totalGrp){ 
			      str.append("<li><A href='"+url+"?col="+col+"&word="+word+"&nowPage="+nowPage+"&bbsno="+fno+"&nPage="+_nowPage+"'>다음</A></li>"); 
			    } 
			    str.append("</ul>"); 
			    str.append("</div>"); 
